                  ...
                  children: [
                    ...
                    TextFormField(
                      ...
                      decoration: InputDecoration(
                        ...
                        suffixIcon: const Icon(Icons.email_outlined, color: ColorManager.greyDark),
                    ...
                    TextFormField(
                      ...
                      decoration: InputDecoration(
                        hintText: '••••••••',
                        suffixIcon: const Icon(Icons.visibility_outlined, color: ColorManager.greyDark),
                        fillColor: const Color(0xFFF3F5F5),
                        filled: true,
                        contentPadding: const EdgeInsets.symmetric(horizontal: 16, vertical: 16),
                        border: OutlineInputBorder(
                    ...
                    const Row(
                      children: [
                        Expanded(child: Divider(color: Color(0xFFE5E9E7), thickness: 1)),
                        Padding(
